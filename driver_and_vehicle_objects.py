...
random_models = ["Onix", "HB20", "Kwid", "Mobi", "Gol", "Argo", "Strada", "Toro", "Compass", "Renegade",
                   "Creta", "Tracker", "Corolla", "Civic", "Hilux"]

colors_exemple = ["Preto", "Branco", "Prata", "Cinza", "Vermelho", "Azul", "Verde", "Amarelo"]

devolution_locations = ["Aeroporto GIG", "Aeroporto SDU", "Centro RJ", "Barra da Tijuca", "Copacabana",
                            "Aeroporto GRU", "Centro SP", "Paulista", "Aeroporto CNF", "Centro BH"]

number_of_vehicles = 25 # Criando 25 carros diferentes
...
for i in range(number_of_vehicles):
    ...
    year_of_manufacture = random.randint(1990, current_year) # Ano entre 1990 e o ano atual
